...
import ProductMoreSold from "../../components/HomeContentProducts/ProductsMoreSold/ProductMoreSold";


const MoreSoldCategoryPage = () => {
const {productsMoreSold}=useFetch(commerce)
    ...
    <div className={styles.filter_and_category_container}>
      ...
      <div className={styles.category_fundament}>
        <div className={styles.products_counts}>
          {productsMoreSold.length} məhsul tapıldı
          <span>
...
export default MoreSoldCategoryPage;
