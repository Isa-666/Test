...
import styles from "./newaccessoriespage.module.css";
...
import NewAccessoriesProducts from "../../components/HomeContentProducts/NewAccessoriesProducts/NewAccessoriesProducts";
const NewAccessoriesPage = () => {
    const {newAccessories, AccessoriesProducts}=useFetch(commerce)
      ...
      <div className={styles.filter_and_category_container}>
        ...
        <div className={styles.category_fundament}>
          <div className={styles.products_counts}>
            {AccessoriesProducts.length} məhsul tapıldı
            <span>
...
export default NewAccessoriesPage